...
@section('content')
    <x-guest-layout>
        <div class="max-w-6xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-xl p-10 md:p-12">
            ...
            <form method="POST" action="{{ route('register') }}" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <x-text-input id="npwp" class="block w-full mt-1" type="text" name="npwp"
                            :value="old('npwp')" />
                    </div>
