...
@section('title', 'Edit Permohonan Kunjungan')
        ...
        <div class="container px-4 mx-auto py-12">
            ...
            <div class="mt-12 mb-12">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <a href="{{ route('permohonan-kunjungan.create') }}"
                        class="text-sm text-gray-500 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition">
                ...
                <div class="mb-2">
                    <h1 class="text-5xl font-bold text-gray-900 dark:text-white">Edit Permohonan Kunjungan</h1>
                </div>
                <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl">
                    Ubah data permohonan kunjungan Anda. Dokumen bersifat opsional saat edit.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
                        @include('components.form-permohonan-kunjungan', ['kunjungan' => $kunjungan])
                    </div>
                </div>
            </div>
