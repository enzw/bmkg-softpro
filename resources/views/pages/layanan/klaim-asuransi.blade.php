    ...
    <div class="container px-4 mx-auto py-10">
        <div class="mt-12 mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400">
                Silakan isi formulir untuk melakukan permohonan kunjungan.
            </p>
        </div>
        ...
        <div class="mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p class="text-blue-800 dark:text-blue-200 text-sm">
                Semua permohonan kunjungan akan diproses oleh tim kami. Anda dapat memantau status permohonan Anda di tabel yang tertera di atas.
            </p>
        </div>
    </div>
</div>
