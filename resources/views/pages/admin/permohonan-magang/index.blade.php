...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-2">
            <div>
                <h1 class="text-4xl font-black text-gray-900 dark:text-white uppercase tracking-tight mb-2">Pelayanan
                    Informasi Geofisika</h1>
            ...
            <div class="px-8 pt-8">
                <div class="relative">
                    ...
                    <input type="text" id="searchPermohonan" 
                        placeholder="Cari jenis layanan, nama pemohon, atau status permohonan..."
