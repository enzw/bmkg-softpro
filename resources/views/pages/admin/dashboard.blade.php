...
@section('content')
    ...
    <!-- Statistics Cards -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8 auto-rows-fr">

        <div
            class="w-full h-full bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-700 flex flex-col justify-between">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <!-- Overall Statistics -->
        <div
            class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-4">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span
                            class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $statistik['total_menunggu'] }}</span>
                    </div>
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-blue-600 dark:text-blue-400 font-semibold">⚙ Diproses</span>
                        <span
                            class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $statistik['total_diproses'] }}</span>
                    </div>
                    <div class="flex items-center justify-between mb-3">
                        <span class="text-green-600 dark:text-green-400 font-semibold">✓ Selesai</span>
                        <span
                            class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $statistik['total_selesai'] }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-red-600 dark:text-red-400 font-semibold">✗ Ditolak</span>
                        <span
                            class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $statistik['total_ditolak'] }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="space-y-4">
                @php
                    $menunggu_pct =
                        $statistik['total'] > 0
                            ? round(($statistik['total_menunggu'] / $statistik['total']) * 100, 1)
                            : 0;
                    $diproses_pct =
                        $statistik['total'] > 0
                            ? round(($statistik['total_diproses'] / $statistik['total']) * 100, 1)
                            : 0;
                    $selesai_pct =
                        $statistik['total'] > 0
                            ? round(($statistik['total_selesai'] / $statistik['total']) * 100, 1)
                            : 0;
                    $ditolak_pct =
                        $statistik['total'] > 0
                            ? round(($statistik['total_ditolak'] / $statistik['total']) * 100, 1)
                            : 0;
                @endphp
    ...
    <!-- Detail Per Layanan -->
    <div
        class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-lg p-6 border border-gray-200 dark:border-gray-700 mb-8">
            ...
            <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-center text-yellow-600 dark:text-yellow-400">
                            {{ $statistik['asuransi']['menunggu'] }}</td>
                        <td class="px-4 py-3 text-center text-blue-600 dark:text-blue-400">
                            {{ $statistik['asuransi']['diproses'] }}</td>
                        <td class="px-4 py-3 text-center text-green-600 dark:text-green-400">
                            {{ $statistik['asuransi']['selesai'] }}</td>
                        <td class="px-4 py-3 text-center text-red-600 dark:text-red-400">
                            {{ $statistik['asuransi']['ditolak'] }}</td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        ...
                        <td class="px-4 py-3 text-center text-yellow-600 dark:text-yellow-400">
                            {{ $statistik['jasa_konsultasi']['menunggu'] }}</td>
                        <td class="px-4 py-3 text-center text-blue-600 dark:text-blue-400">
                            {{ $statistik['jasa_konsultasi']['diproses'] }}</td>
                        <td class="px-4 py-3 text-center text-green-600 dark:text-green-400">
                            {{ $statistik['jasa_konsultasi']['selesai'] }}</td>
                        <td class="px-4 py-3 text-center text-red-600 dark:text-red-400">
                            {{ $statistik['jasa_konsultasi']['ditolak'] }}</td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-4 py-3 font-semibold">Peta Sebaran</td>
                        <td class="px-4 py-3 text-center font-bold">{{ $statistik['peta_sebaran']['total'] }}</td>
                        <td class="px-4 py-3 text-center text-yellow-600 dark:text-yellow-400">
                            {{ $statistik['peta_sebaran']['menunggu'] }}</td>
                        <td class="px-4 py-3 text-center text-blue-600 dark:text-blue-400">
                            {{ $statistik['peta_sebaran']['diproses'] }}</td>
                        <td class="px-4 py-3 text-center text-green-600 dark:text-green-400">
                            {{ $statistik['peta_sebaran']['selesai'] }}</td>
                        <td class="px-4 py-3 text-center text-red-600 dark:text-red-400">
                            {{ $statistik['peta_sebaran']['ditolak'] }}</td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-4 py-3 font-semibold">Survey</td>
                        <td class="px-4 py-3 text-center font-bold">{{ $statistik['survey']['total'] }}</td>
                        <td class="px-4 py-3 text-center text-yellow-600 dark:text-yellow-400">
                            {{ $statistik['survey']['menunggu'] }}</td>
                        <td class="px-4 py-3 text-center text-blue-600 dark:text-blue-400">
                            {{ $statistik['survey']['diproses'] }}</td>
                        <td class="px-4 py-3 text-center text-green-600 dark:text-green-400">
                            {{ $statistik['survey']['selesai'] }}</td>
                        <td class="px-4 py-3 text-center text-red-600 dark:text-red-400">
                            {{ $statistik['survey']['ditolak'] }}</td>
                    </tr>
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <td class="px-4 py-3 font-semibold">Layanan Data</td>
                        <td class="px-4 py-3 text-center font-bold">{{ $statistik['layanan_data']['total'] }}</td>
                        <td class="px-4 py-3 text-center text-yellow-600 dark:text-yellow-400">
                            {{ $statistik['layanan_data']['menunggu'] }}</td>
                        <td class="px-4 py-3 text-center text-blue-600 dark:text-blue-400">
                            {{ $statistik['layanan_data']['diproses'] }}</td>
                        <td class="px-4 py-3 text-center text-green-600 dark:text-green-400">
                            {{ $statistik['layanan_data']['selesai'] }}</td>
                        <td class="px-4 py-3 text-center text-red-600 dark:text-red-400">
                            {{ $statistik['layanan_data']['ditolak'] }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="mt-12 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
        ...
        <p class="text-blue-800 dark:text-blue-200 text-sm">
            Dashboard ini menampilkan ringkasan semua permohonan yang masuk. Anda dapat mengelola setiap permohonan melalui
            menu yang tersedia di sebelah kiri.
        </p>
    </div>
    </div>
    </div>
