...
@section('content')
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-gray-600 dark:text-gray-400">
                                Kelola semua permohonan pemetaan di sini.
                            </p>
                        </div>
                        <a href="{{ route('admin.pemetaan.create') }}"
                        ...
                        <tbody>
                            ...
                            <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-6 py-4 flex gap-2">
                                    <a href="{{ route('admin.pemetaan.edit', $item) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                                    <form action="{{ route('admin.pemetaan.destroy', $item) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 text-center">
                    <p class="text-gray-600 dark:text-gray-400">Belum ada permohonan pemetaan.</p>
                </div>
                @endif
@endsection
