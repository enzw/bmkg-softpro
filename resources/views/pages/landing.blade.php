...
@section('content')
    <div class="landing-page dark:bg-slate-900 dark:text-white">
        <header
            class="relative z-0 h-[calc(70vh+200px)] lg:h-[calc(100vh+200px)] bg-[linear-gradient(135deg,rgba(16,65,48,0.7),rgba(5,20,10,0.8)),url('/public/images/slides/0.jpeg')] bg-cover bg-no-repeat bg-fixed bg-center overflow-hidden">
            <!-- Animated background elements -->
            <div class="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/20"></div>
            <div class="absolute top-0 right-0 w-96 h-96 bg-green-500/10 rounded-full blur-3xl -mr-48 -mt-48"></div>
            <div class="absolute bottom-0 left-0 w-96 h-96 bg-emerald-500/10 rounded-full blur-3xl -ml-48 -mb-48"></div>
            
            <div class="container grid h-full px-4 mx-auto text-center text-white lg:h-screen place-content-center relative z-10">
                {{-- Eyebrow --}}
                <a href="https://apps.bmkg.go.id/" target="__blank"
                    class="px-6 py-3 mx-auto text-sm font-semibold transition duration-300 rounded-full bg-white/20 hover:bg-white/40 hover:text-white hover:-translate-y-1 backdrop-blur-md max-w-max mb-8 border border-white/30 hover:border-white/50 group">
                    <i class="mr-2 text-green-300 fa-solid fa-bullhorn"></i> Download aplikasi BMKG sekarang
        ...
        <section id="layanan" class="layanan -mt-[200px] py-20 relative z-0 bg-gradient-to-b from-green-50 to-white dark:from-slate-800 dark:to-slate-900">
            <div class="container px-4 mx-auto">
                <div class="mb-12 text-center">
                    <span class="inline-block px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-sm font-semibold mb-4">Layanan Tersedia</span>
                    <h3 class="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">Layanan Kami</h3>
                    <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Berbagai layanan geofisika komprehensif untuk memenuhi kebutuhan Anda</p>
                </div>
                <div
                    ...
                    @foreach ($layanan as $item)
                        <div
                            ...
                            <div class="px-6 py-5 flex flex-col flex-grow">
                                <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-green-600 dark:group-hover:text-green-400 transition duration-300">
                                    {{ $item['nama'] }}
                                </h4>
        ...
        <section id="tutorial" class="py-20 bg-gradient-to-b from-green-50/30 to-white dark:from-slate-800 dark:to-slate-900 relative z-0 overflow-hidden">
            <div class="container px-4 mx-auto">
                <div class="mb-12 text-center">
                    <span class="inline-block px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-full text-sm font-semibold mb-4">Panduan Permohonan</span>
                    <h3 class="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">Cara Mengajukan Permohonan</h3>
                    <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Ikuti langkah-langkah sederhana untuk mengajukan permohonan layanan</p>
                </div>
                
                <div class="max-w-4xl mx-auto space-y-3">
                    @foreach ($layanan as $item)
                        <div class="group overflow-hidden flex flex-col transition duration-500 bg-white dark:bg-slate-800 rounded-xl shadow-lg dark:shadow-slate-900/50 hover:-translate-y-3 hover:shadow-2xl dark:hover:shadow-green-900/30 border border-gray-100 dark:border-slate-700 hover:border-green-200 dark:hover:border-green-800">
                            <button onclick="toggleAccordion(this)" class="w-full flex items-center justify-between p-6 text-left hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 dark:hover:from-slate-700 dark:hover:to-slate-700 transition duration-200 group">
                                <h4 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-3 group-hover:text-green-600 dark:group-hover:text-green-400 transition duration-300">
                                    <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 group-hover:bg-green-600 dark:group-hover:bg-green-600 group-hover:text-white dark:group-hover:text-white transition duration-300 flex-shrink-0">
                                        <i class="fas fa-chevron-right text-sm group-hover:translate-x-1 transition-transform duration-200 accordion-icon"></i>
                                    </span>
                                    {{ $item['nama'] }}
                                </h4>
                            </button>
                            <div class="accordion-content max-h-0 overflow-hidden transition-all duration-300 border-t border-gray-200 dark:border-slate-700">
        ...
        <section id="hubungi-kami" class="py-20 bg-gradient-to-br from-white via-gray-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 relative overflow-hidden z-0">
            ...
            <div class="absolute inset-0 overflow-hidden">
                <div class="absolute -top-40 -right-40 w-80 h-80 bg-green-500/10 dark:bg-green-500/10 rounded-full blur-3xl"></div>
                <div class="absolute -bottom-40 -left-40 w-80 h-80 bg-blue-500/10 dark:bg-blue-500/10 rounded-full blur-3xl"></div>
            </div>
            
            <div class="container px-4 mx-auto relative z-10">
                <div class="mb-16 text-center">
                    <span class="inline-block px-4 py-2 bg-green-100 dark:bg-green-500/20 text-green-700 dark:text-green-300 rounded-full text-sm font-semibold mb-4 border border-green-200 dark:border-green-500/30">Kontak</span>
                    <h2 class="mb-4 text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white">Hubungi Kami</h2>
                    <p class="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">Kami siap membantu menjawab pertanyaan dan kebutuhan Anda</p>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                    <!-- Alamat -->
                    <div class="group bg-white dark:bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg dark:shadow-xl p-8 text-center hover:bg-gray-50 dark:hover:bg-white/20 transition duration-300 border border-gray-200 dark:border-white/20 hover:border-green-300 dark:hover:border-white/40 hover:-translate-y-2">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full mb-6 shadow-lg group-hover:scale-110 transition duration-300">
                    ...
                    <!-- Telepon -->
                    <div class="group bg-white dark:bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg dark:shadow-xl p-8 text-center hover:bg-gray-50 dark:hover:bg-white/20 transition duration-300 border border-gray-200 dark:border-white/20 hover:border-blue-300 dark:hover:border-white/40 hover:-translate-y-2">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full mb-6 shadow-lg group-hover:scale-110 transition duration-300">
                        ...
                        <p class="text-gray-700 dark:text-gray-100 space-y-3">
                            <div>
                                <a class="inline-block hover:text-green-600 dark:hover:text-green-300 transition duration-300 font-semibold">
                                    (0274) 6498383
                                </a>
                            </div>
                            <div>
                                <a href="https://wa.me/6289612643202" class="inline-flex items-center justify-center gap-2 hover:text-green-600 dark:hover:text-green-300 transition duration-300 font-semibold">
                    ...
                    <!-- Email -->
                    <div class="group bg-white dark:bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg dark:shadow-xl p-8 text-center hover:bg-gray-50 dark:hover:bg-white/20 transition duration-300 border border-gray-200 dark:border-white/20 hover:border-purple-300 dark:hover:border-white/40 hover:-translate-y-2">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-600 rounded-full mb-6 shadow-lg group-hover:scale-110 transition duration-300">
                        ...
                        <p class="text-gray-700 dark:text-gray-100">
                            <a href="mailto:stageof.yogya@bmkg.go.id" class="hover:text-green-600 dark:hover:text-green-300 transition duration-300 font-semibold break-all">
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg dark:shadow-2xl border border-gray-200 dark:border-white/20 backdrop-blur-lg hover:shadow-xl dark:hover:shadow-green-900/50 transition duration-300">
