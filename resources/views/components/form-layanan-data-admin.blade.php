...
<div
    ...
    <div class="p-8">
        ...
        <form
            action="{{ $is_edit ? route('admin.layanan-data.update', ['layanan_datum' => $permohonan->id]) : route('admin.layanan-data.store') }}"
            ...
            <div class="relative pl-6 border-l-2 border-blue-500/30 space-y-6">
                ...
                <div>
                    <label for="keterangan" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Jenis
                        Data dan Deskripsi Kebutuhan <span class="text-red-500">*</span></label>
                    <textarea id="keterangan" name="keterangan" rows="3" placeholder="Jelaskan kebutuhan data Anda..."
                        required
                    ...
                    <div>
                        ...
                        @if ($is_edit && $permohonan && $permohonan->surat_permohonan)
                            <div
                                ...
                                <a href="{{ route('admin.layanan-data.download-file', ['id' => $permohonan->id, 'fileName' => basename($permohonan->surat_permohonan)]) }}"
                    ...
                    <div>
                        ...
                        @if ($is_edit && $permohonan && $permohonan->ktp)
                            <div
                                ...
                                <a href="{{ route('admin.layanan-data.download-file', ['id' => $permohonan->id, 'fileName' => basename($permohonan->ktp)]) }}"
                                    class="inline-flex items-center gap-2 text-[10px] font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition uppercase tracking-widest">
