...
<div
    ...
    <div class="p-8">
        ...
        <form
            action="{{ $is_edit ? route('admin.klaim-asuransi.update', ['klaim_asuransi' => $permohonan->id]) : route('admin.klaim-asuransi.store') }}"
            ...
            <div class="relative pl-6 border-l-2 border-green-500/30 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        <label for="nama_user" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                            Nama Lengkap <span class="text-red-500">*</span>
                        </label>
                        <input id="nama_user" type="text" name="nama_user" placeholder="Masukkan nama lengkap"
                ...
                <div>
                    <label for="perusahaan" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                        Nama Instansi <span class="text-red-500">*</span>
                    </label>
                    <input id="perusahaan" type="text" name="perusahaan" placeholder="Masukkan nama instansi/perusahaan"
            ...
            <div class="relative pl-6 border-l-2 border-blue-500/30 space-y-6">
                ...
                <div>
                    <label for="lokasi" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                        Lokasi Kejadian <span class="text-red-500">*</span>
                    </label>
                    <input id="lokasi" type="text" name="lokasi" placeholder="Masukkan lokasi kejadian"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        <label for="latitude" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                            Latitude <span class="text-gray-400 font-normal text-xs">(Opsional)</span>
                        </label>
                        <input id="latitude" type="number" step="0.00000001" name="latitude" placeholder="-90 hingga 90"
                            value="{{ $is_edit ? old('latitude', $permohonan->latitude) : old('latitude') }}"
                            class="w-full px-6 py-4 rounded-2xl border border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/40 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all font-medium" />
                        <x-input-error :messages="$errors->get('latitude')" class="mt-2" />
                    </div>
                    <div>
                        <label for="longitude" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
                            Longitude <span class="text-gray-400 font-normal text-xs">(Opsional)</span>
                        </label>
                ...
                <div>
                    <label for="tanggal" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">
